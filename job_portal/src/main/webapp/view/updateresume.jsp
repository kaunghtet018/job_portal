...
<title>Resume Update Page</title>
<link
		...
		<div class="container">
			<div class="row justify-content-center my-5">
				<div class="col-10 bg-light" style="border:1px solid black;border-radius: 10px;">
					<form action="resume?mode=UPDATERESUME" method="post">
								...
								<div class="col-6">
									...
									<div class="mb-2 input-group">
										<span class="input-group-text"> N </span> <input type="text"
											...
											value="${resume.name}" required="required">
									</div>
								...
								<div class="col-6">
									...
									<div class="mb-2 input-group">
										<span class="input-group-text"> P </span> <input type="text"
											...
											value="${resume.phone}" required="required">
									</div>
									...
									<div class="mb-2 input-group">
										<span class="input-group-text"> E </span> <input type="text"
											...
											value="${resume.email }" required="required">
									</div>
									...
									<div class="mb-2 input-group">
										<span class="input-group-text"> A </span> <input type="text"
											...
											value="${resume.address }" required="required">
									</div>
								...
								<div class="col">
									...
									<div>
										<textarea class="form-control" rows="4" name="about"
											required="required">${resume.about}</textarea>
									</div>
								</div>
											...
											<div class="row mb-3">
												<div class="col-3">
													<input type="text" class="form-control" name="certificate"
														value="${edu.certificate }" placeholder="Certificate">
												</div>
												<div class="col-3">
												...
												<div class="col-4">
													<input type="text" class="form-control" name="daterange1"
														value="${edu.dateRange }" placeholder="Graduation Period">
												</div>
												<div class="col-2">
													<c:choose>
											...
											<div class="row mb-3">
												...
												<div class="col-3">
													<input type="text" class="form-control" name="daterange2"
														value="${exp.dateRange }" placeholder="Worked Period">
												</div>
												<div class="col-2">
													<c:choose>
														<c:when test="${check eq 'first'}">
											...
											<div class="row mb-3">
												<div class="col-6">
													<input type="text" class="form-control" name="skill"
														value="${skills.skill }" placeholder="Skill">
												</div>
